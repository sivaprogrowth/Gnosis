...
Illustration of a human silhouette surrounded by a network of smaller, connected human figures.

Alexandra Citrin-Safadi/WSJ

### Quick Summary

- A new working paper found that AI-powered startups have about 25% fewer employees than comparable companies not built around AI capabilities.
- The study showed that AI startups had about 15% fewer entry-level workers, 15% fewer managers, and fewer rungs in the corporate ladder.
- Startups that provided services, such as mental health and tutoring, saw the most drastic drop-off, with workforces 70% smaller than non-AI peers.

This summary was generated with AI and reviewed by an editor. about how we use artificial intelligence in our journalism.

- A new working paper found that AI-powered startups have about 25% fewer employees than comparable companies not built around AI capabilities.View more

How will AI reshape company workforces? They will be a lot smaller and flatter, if startups like Pointhound are any indication.
...
![Pointhound CEO Jay Reno, smiling at the camera.](https://images.wsj.net/im-51695060?width=639&size=0.800&pixel_ratio=3)

Pointhound CEO Jay Reno, smiling at the camera.

Pointhound CEO Jay Reno pointhound

The newest generation of companies, infused with AI from the start, offer a vision of how work could soon be structured elsewhere in American corporations: [fewer co-workers](https://www.wsj.com/business/companies-hiring-jobs-ai-9ef675b6?mod=article_inline); more on-staff engineers; and [a flatter structure](https://www.wsj.com/lifestyle/careers/management-jobs-shrinking-white-collar-workers-cc761cb7?mod=article_inline) in which nearly everyone is a player-coach instead of strictly overseeing teams.

A new [working paper](https://urldefense.com/v3/__https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6905079&__cf_chl_f_tk=pkfx6ZdhAsH6yu7FwRcHoVoqRlzbQGK3wZ5BwjiFszk-1782811220-1.0.1.1-7gz4Iiia691dmFcg22WWKaBqxXnUFePnJRcXpM..T84__;!!F0Stn7g!BUZ-HD3RfmpSKlvYR83B9guBFHLnHwwzbHXxSjOpqcVVbNKp3v_6gMe2SpMBBLGIbxJ_QTSQXyJNfZt6KXZ6ARE$) examining thousands of recent Y Combinator and other U.S. venture-backed startups indicates as much. The study found that AI-powered startups have about 25% fewer employees than comparable companies not built around AI capabilities.
...
In short, they are the proving ground for the philosophy that corporate giants like [Amazon.com](https://www.wsj.com/market-data/quotes/AMZN) and [Meta Platforms](https://www.wsj.com/market-data/quotes/META) are now channeling as they reorganize, de-layer, [cut jobs](https://www.wsj.com/tech/ai/meta-begins-laying-off-thousands-of-employees-as-it-transforms-around-ai-3c31a9eb?mod=article_inline) and invest in more AI.

When [Microsoft’s](https://www.wsj.com/market-data/quotes/MSFT) Xbox division said in early July that it would lay off 3,200 people, for instance, it pledged to cut management layers to between three and five. Before, work in some parts of the company went through as many as 14 layers, and Xbox’s platform teams have swelled even as its player base has declined, its CEO said.
...
![Asha Sharma, CEO of Xbox, speaking at a conference.](https://images.wsj.net/im-24321144?width=639&size=0.800&pixel_ratio=3)

Asha Sharma, CEO of Xbox, speaking at a conference.

Xbox CEO Asha Sharma David Paul Morris/Bloomberg News
...
Appeared in the July 16, 2026, print edition as 'AI Is Reshaping Structures of the Workplace'.
