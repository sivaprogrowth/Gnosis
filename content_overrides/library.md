...
<!-- All HTML blocks flush-left so CommonMark's rule-6 HTML-block parser
     treats each opening tag as the start of a new block. Indenting the
     inner tags 2+ spaces after a blank line caused Quartz to render them
     as raw text on the first attempt. -->
...
<a href="/library" class="active" data-icon="book">Book Library</a>
...
<div>
<h1 id="lib-title">Book Library</h1>
