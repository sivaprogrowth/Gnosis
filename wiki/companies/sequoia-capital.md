...
A top-tier VC firm that the wiki already tracks similar entities for (Andreessen Horowitz, First Round Capital, Lightspeed India Partners, WestBridge Capital, Y Combinator). Multiple existing source pages reference Sequoia-backed companies, making it a plausible cross-link target.
