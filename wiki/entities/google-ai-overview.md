...
AIO is the AI surface with the largest total addressable reach (appears in half of Google searches, which still dominates global search share). For ProGrowth clients, AIO visibility is often the highest-ROI GEO target because the audience volume dwarfs Perplexity/Claude. Critical engine to track via `overviews.progrowth.services`.
