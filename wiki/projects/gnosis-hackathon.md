...
tags: [project, progrowth, demo, active]
...
## What it proves for ProGrowth

A productized version of this pattern is a credible SaaS play for fractional operators (see [[progrowth]] product roadmap). Each client engagement could have its own wiki that the fractional CMO operates from — client takes the artifact home when the engagement ends. Harder for Semrush (pure SaaS) or [[marketri]] (pure advisory) to match.
